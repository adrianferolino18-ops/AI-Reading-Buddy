...
<?php $__env->startSection('title', 'Reading Room Collections'); ?>
...
<div class="max-w-6xl mx-auto px-4 py-8 text-slate-100">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div class="bg-slate-900/60 border border-white/10 rounded-2xl p-6 shadow-md sticky top-20">
            ...
            <form action="<?php echo e(route('modules.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Herd\ai-reading-buddy\resources\views/library.blade.php ENDPATH**/ ?>